...
import "@pingora/analytics/env";
import "@pingora/db/env.mjs";
...
export const env = createEnv({
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_URL: process.env.NEXT_PUBLIC_URL ?? (process.env.VERCEL_URL ? `https://${process.env.VERCEL_URL}` : "http://localhost:3000"),
