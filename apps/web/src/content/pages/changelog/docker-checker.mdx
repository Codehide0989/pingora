...
The image is available at `ghcr.io/pingorahq/checker:latest`.
...
We have wrote a [guide](https://docs.pingora.dev/guides/how-deploy-checker-koyeb) to help you deploy our checker on [Koyeb](https://www.koyeb.com/).

Thanks to [Depot](https://depot.dev/?utm_source=Opource=Pingora) for the fast build and the easy integration with GitHub Actions.