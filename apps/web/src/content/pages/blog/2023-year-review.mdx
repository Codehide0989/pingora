...
It has been a wild six months for us at Pingora. In late June, we began
writing the first line of code for Pingora.
...
We wrote the first line of code for Pingora.
...
We launched the initial version of Pingora, which was more than just a basic
...
After that Pingora trended on GitHub for a few days.
...
We launched Pingora 🔥. We didn't waste too much time over-engineering it.
