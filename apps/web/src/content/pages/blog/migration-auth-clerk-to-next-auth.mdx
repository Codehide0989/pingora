...
Our goal is to improve the contributor experience (CX) for Pingora by
...
When we started Pingora, we needed a way to authenticate users. We wanted to
...
[extended adapter](https://github.com/pingoraHQ/pingora/blob/main/apps/web/src/lib/auth/adapter.ts)
...
> [#812](https://github.com/pingoraHQ/pingora/issues/812) if you want to
> help us 🤗.
...
[ping@pingora.dev](mailto:ping@pingora.dev).

Our main PR for the migration is
[#801](https://github.com/pingoraHQ/pingora/pull/801) while we implemented
the magic link for dev mode in
[#806](https://github.com/pingoraHQ/pingora/pull/806) and improved the
types in [#807](https://github.com/pingoraHQ/pingora/pull/807).
