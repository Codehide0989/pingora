...
But there’s more. As developers, we live in our IDEs and terminals. That’s why we really want improve our **pingora CLI** and `config.pingora.yaml` to make developer experience neat (DX). Allowing you to run your synthetic check in you CI workflow, or from your terminal.
...
(a) *Supporting the community* as they build on top of Pingora core infra.

(b) *Building smaller, easily self-hostable solutions* (e.g., [vercel-edge-ping](https://github.com/pingoraHQ/vercel-edge-ping)).
...
If there’s something crucial you’re looking for, we’d love to hear from you. Join our [Discord](https://pingora.dev/discord) or drop us a [message](mailto:ping@pingora.dev)!
