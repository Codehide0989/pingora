...
Remove the "powered by pingora.dev" branding from your status pages. Present a completely branded experience that aligns with your company's identity. Your customers will see only your brand, maintaining consistency across all touchpoints.

Together with the [custom themes](https://themes.pingora.dev) we provide, you can create a fully branded status page experience.
