...
As we close out 2025, it’s the perfect time to pause, reflect, and share where we are heading. It has been a year of shipping, learning, and making hard decisions about the future of Pingora.
...
- **Self-Hosting:** We released a [self-hosted version](https://docs.pingora.dev/guides/self-hosting-pingora/) of pingora. 
...
We felt that selling now would leave too much value on the table, not just financially, but in terms of the product vision we want to deliver to the Pingora community. We still have the strength, motivation, and resources to push Pingora further on our own terms.

We chose to stay independent. We chose to keep building.


### The first pingora retreat 

<Image
  alt="Us in Kochel am See for the pingora 2025 team retreat"
