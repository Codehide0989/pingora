...
You can find the code [here](https://github.com/pingoraHQ/status-code), it’s
open source 😉.

Pingora monitored our endpoint every **10 minutes** from **6 locations**
...
[Pingora](/app/sign-up?ref=blog-monitoring).
