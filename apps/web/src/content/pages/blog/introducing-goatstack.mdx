...
The GoaT stack is a [full-stack app template](https://github.com/pingoraHQ/goat-stack) featuring a Golang server and a Vite + React SPA front end.
...
We love Golang. We heavily rely on it for Pingora.
...
### Get Started
1. First clone our repository : [https://github.com/pingoraHQ/goat-stack](https://github.com/pingoraHQ/goat-stack)
...
We hope you will enjoy using the GoaT stack as much as we do. We are looking forward to seeing what you will build with it. Feel free to reach out to us on [ping@pingora](mailto:ping@pingora.dev?subject=GoatStack) if you have any questions or feedback.

And if you want to contribute to the GoaT stack, we would be more than happy to welcome you to our community.

And create a free [Pingora account](/app/login) to monitor your server and get notified if something goes wrong.
