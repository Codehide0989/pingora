---
title: "Our Journey Building Pingora: From Idea to Reality"
description: "Reflecting on our first year of building Pingora, an open source synthetic monitoring platform that has grown to more than 6,000 GitHub stars and 5,000 users."
author: "Thibault Le Ouay"
publishedAt: "2024-09-26"
image: "/assets/posts/reflecting-1-year-building-pingora/first-year.png"
category: "company"
---

In one year, we've grown our open-source synthetic monitoring platform to more than 6,000 GitHub stars and 5,000 users. This article will reflect on our first year of building Pingora.

We've written about Pingora's journey before:

- [Celebrated 48 hours of Pingora](/blog/the-first-48-hours?ref=blog-1year)
...
<Image
  alt="Twitter"
  src="/assets/posts/reflecting-1-year-building-pingora/twitter.png"
  width={650}
  height={575}
/>
...
Prior to launching Pingora, we had experience with tools like:
...
We started at the right time where lots of Open-Source Software companies like our friends at [papermark.io](https://papermark.io?ref=pingora.dev), [uninbox.com](http://uninbox.com?ref=pingora.dev) or [documenso.com](http://documenso.com?ref=pingora.dev) flourished at the same time and made it into the oss-friends list by [formbricks.com](http://formbricks.com?ref=pingora.dev).
...
Additionally, creating tools and components people love is a great way to draw attention and leverage SEO: [time.pingora.dev](https://time.pingora.dev) - a shadcn time picker drives 3k visitors per month organically. Same goal is with [data-table.pingora.dev](https://data-table.pingora.dev) - an extensive data-table for your realtime data.
...
- Plans to transition to Pingora at the end of the year

> After working evenings and nights on Pingora for over a year, I had to make a personal decision to cut back on my 9-to-5 job. I've been neglecting other pillars in my life that I want to nurture again. While losing the income security, I'll free up mental space and open myself to new opportunities.
>
...
Despite working remotely for most of the Pingora history, we finally met in mid-August. Max visited me, and we spent two great days:
...
<Image
  alt="Us"
  src="/assets/posts/reflecting-1-year-building-pingora/us.png"
  width={650}
  height={575}
/>
...
This time reinforced our commitment to Pingora and our shared vision for its future. We didn't write a single line of code during that time—proving that you don't need to grind 24/7 to make progress.
...
> If you have ideas, requests or wanna chat feel free to contact us via [ping@pingora.dev](mailto:ping@pingora.dev) or join our Discord channel [/discord](https://pingora.dev/discord)
>

Pingora has grown from a simple idea into a promising open-source project with a dedicated user base. We're committed to continuing our innovation, engaging with our community, and building tools that developers love.

Stay tuned for more updates as we continue to improve Pingora!


<Image
  alt="To infinity and beyond"
  src="/assets/posts/reflecting-1-year-building-pingora/image.png"
  width={650}
  height={575}
/>
...
Want to join us on this journey? [Star us on GitHub](https://www.github.com/pingoraHQ/pingora)! 🌟
