---
title: "Global Latency Monitoring: Benchmarking a Hono App on Hetzner with Pingora"
...
At Pingora, we offer **global monitoring** to give you an unbiased, external view of your service's performance. To truly test our monitoring capabilities and gather real-world latency data, we decided to benchmark a simple application deployed outside our internal network.
...
To prevent internal networking biases from skewing the results, I deployed a minimal test application a [**Hono server**](https://github.com/pingoraHQ/status-code/) on third-party cloud providers, independent from Pingora's infrastructure.
...
##  Monitoring Strategy with Pingora
...
We've set up Pingora probes across multiple continents and providers, specifically leveraging monitoring locations from:
...
I have defined our monitor with the pingora cli, and this is the exact configuration used for it :
