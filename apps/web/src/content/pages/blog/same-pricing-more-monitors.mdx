...
We’re updating our plans alongside the launch of the new [dashboard](https://pingora.dev/blog/new-dashboard-we-are-so-back).

A lot of users rely on pingora for uptime checks and don’t really care about monitoring from _all_ 35 regions at once.
...
Got questions, relying on response logs as a Hobby user or have been using parallel scheduling on all regions within the Starter plan? Reach out at [ping@pingora.dev](mailto:ping@pingora.dev).
