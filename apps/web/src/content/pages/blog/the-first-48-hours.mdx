---
title: "48 hours of public Pingora"
...
[QStash](https://upstash.com/qstash?ref=pingora), we implemented a hotfix to
...
Join [Discord](https://pingora.dev/discord) if you want to learn more or just
have a chat!
...
an account on [pingora](https://pingora.dev) and share yours on
[Discord](https://pingora.dev/discord) - it's fun to watch! 🍿
