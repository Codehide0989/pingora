...
author: "pingora"
description: "The terms and conditions for pingora"
category: "company"
---

Subject to these Terms of Service (this "Agreement"), [pingora.dev](/)
("Pingora", "we", "us" and/or "our") provides access to Pingora's cloud
...
By signing up and using the services provided by Pingora (referred to as the
"Service"), you are agreeing to be bound by the following terms and conditions
("Terms of Service"). The Service is owned and operated by Pingora ("Us",
"We", or "Our").

## 2. Description of Service

Pingora provides an open source monitoring and status page tool. ("the
Product"). The Product is accessible at pingora.dev and other domains and
...
directed to our support team at support@pingora.dev.
...
By using Pingora , you acknowledge that you have read these Terms of Service,
