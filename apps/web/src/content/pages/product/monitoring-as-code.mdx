...
## Why choose pingora for uptime monitoring as code?
...
Once set, apply your changes via [CLI](https://docs.pingora.dev/tutorial/get-started-with-pingora-cli/):

```bash
pingora monitors apply
```

Check our [GitHub repository](https://github.com/pingoraHQ/cli-template) to see the `YAML` templates of how to monitor **MCP**, **GraphQL**,... endpoints.
...
Check out the [Terraform Provider](https://registry.terraform.io/providers/pingoraHQ/pingora/latest) on the Terraform Registry.
