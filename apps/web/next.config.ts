...
const nextConfig: NextConfig = {
  ...
  transpilePackages: ["@pingora/ui", "@pingora/api"],
  ...
  async redirects() {
    return [
      ...
      {
        source: "/app/:path*",
        destination: "https://app.pingora.dev/",
        permanent: true,
      },
    ];
  },
      ...
      beforeFiles: [
        ...
        // New design: proxy app routes to external host with slug prefix
        {
          ...
          has: [
            ...
            {
              type: "host",
              value: "(?<slug>[^.]+)\\.(pingora\\.dev|localhost)",
            },
          ],
        ...
        // Handle API routes for custom domains
        {
          ...
          has: [
            { type: "cookie", key: "sp_mode", value: "new" },
            {
              type: "host",
              value:
                "^(?!.*\\.pingora\\.dev$)(?!pingora\\.dev$)(?<domain>.+)$",
            },
          ],
