...
export default defineConfig({
  ...
  integrations: [
    ...
    starlight({
      ...
      social: [
        {
          icon: "github",
          label: "GitHub",
          href: "https://github.com/pingoraHQ/pingora",
        },
        {
          icon: "discord",
          label: "Discord",
          href: "https://www.pingora.dev/discord",
        },
        {
          icon: "blueSky",
          label: "BlueSky",
          href: "https://bsky.app/profile/pingora.dev",
        },
      ],
      components: {
      ...
      editLink: {
        baseUrl: "https://github.com/pingoraHQ/pingora/app/docs",
      },
      customCss: [
      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: "Get Started with Pingora CLI",
              slug: "tutorial/get-started-with-pingora-cli",
            },
          ],
        },

        {
          ...
          items: [
            ...
            {
              label: "How to self-host pingora",
              slug: "guides/self-hosting-pingora",
            },
          ],
        },
        {
      ...
      plugins: [
        starlightLlmsTxt({
          projectName: "pingora docs",
          description:
            "pingora is an open-source global uptime monitoring platform that offers a status page and monitoring as code.",
        }),
        starlightImageZoom(),
