...
description: "How to manage monitors as code with pingora?"
---
...
pingora provides a [CLI](/tutorial/get-started-with-pingora-cli) tool that allows you to create, update, and delete monitors as code. To get started, you need to install the CLI tool.
...
You can find more examples in the [pingora Template GitHub repository](https://github.com/pingoraHQ/cli-template/).
