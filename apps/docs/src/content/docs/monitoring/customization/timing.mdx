---
title: Timing
description: "How to set up timing threshold for your synthetic checks in pingora"
---

By default, pingora will timeout after `45s` but you can set a custom timeout (max. `45s`).
