...
description: "Monitor metrics are the data points that are collected by the monitor during the check in pingora."
---
...
- **Transfer timing**: The time taken to download the response body.
  ...
  <Image
    ...
    alt="pingora response log timing"
  />
