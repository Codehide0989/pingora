---
title: Monitors
description: "How to connect your monitors for your status page in pingora"
---
...
You can see an example of a public monitor at [https://status.pingora.dev/monitors/1](https://status.pingora.dev/monitors/1).
