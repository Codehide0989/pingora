...
description: "A step-by-step tutorial to create your first monitor with pingora"
---
...
- An pingora account (free tier available at [pingora.dev](https://www.pingora.dev))
...
- **Simulating Clients:** Adding a User-Agent header to simulate traffic from a specific browser or device.
    ...
    pingora automatically includes the `"User-Agent": "pingora/1.0"` header in every request. This makes it easy to identify and filter out our monitoring traffic from your server logs or analytics.
