...
This tutorial will guide you through the process of creating a status page in pingora. A status page is a web page that displays the status of your services, building trust with your users through transparency.
...
You can add a Custom Domain to your status page. Custom domains allow you to use your own domain name instead of the default domain name provided by pingora.
...
- **[Status Page Examples](https://www.pingora.dev/showcase)** - See status pages from other users
