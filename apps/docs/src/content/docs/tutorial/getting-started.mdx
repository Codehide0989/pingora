...
description: Step-by-step lessons to learn pingora from the ground up
sidebar:
...
- Use pingora CLI for automation

### Core Tutorials

Start your journey with pingora:
...
- **[Get Started with pingora CLI](/tutorial/get-started-with-pingora-cli)** - Automate monitor management with our command-line tool
