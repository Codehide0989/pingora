---
title: How-to Guides
description: Problem-solving guides for specific tasks with pingora
sidebar:
    label: Introduction
    order: 1
---
...
- Customize and extend your pingora setup
...
- **[Self-Host pingora](/guides/self-hosting-pingora)** - Deploy pingora on your own servers
