...
Reference documentation provides **technical specifications** and detailed information about pingora components, APIs, and configuration options. This is where you look up exact parameter names, return types, and available options.
...
For programmatic access to pingora:
- **[REST API](https://api.pingora.dev/v1)** - Full REST API reference with interactive examples
