...
import (
	...
	"github.com/pingorahq/pingora/apps/private-location/internal/database"
	"github.com/pingorahq/pingora/apps/private-location/internal/models"
...
func (h *privateLocationHandler) Monitors(ctx context.Context, req *connect.Request[private_locationv1.MonitorsRequest]) (*connect.Response[private_locationv1.MonitorsResponse], error) {
	token := req.Header().Get("pingora-token")
	if token == "" {
