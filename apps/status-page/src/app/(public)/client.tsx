...
import { THEMES, THEME_KEYS } from "@pingora/theme-store";
    ...
    <SectionGroup>
      <SectionGroupHeader>
        ...
        <h2 className="font-medium text-muted-foreground md:text-lg">
          View all the pingora themes for your status page and learn how to
      ...
      <Section>
        ...
        <div className="prose dark:prose-invert prose-sm max-w-none">
          <p>
            ...
            <code>@pingora/theme-store</code> package. You&apos;ll only need
          ...
          <p>
            Go to the{" "}
            <Link href="https://github.com/pingoraHQ/pingora/tree/main/packages/theme-store">
              GitHub directory
            </Link>{" "}
