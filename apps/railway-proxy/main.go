...
func proxy(c *gin.Context) {
	...
	case "europe-west4-drams3a":
		targetUrl = "http://pingora-checker-eu-west.railway.internal:8080"
	case "us-east4-eqdc4a":
		targetUrl = "http://pingora-checker-us-east.railway.internal:8080"
	case "us-west2":
		targetUrl = "http://pingora-checker-us-west.railway.internal:8080"
