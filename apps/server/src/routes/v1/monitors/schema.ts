...
import { monitorJobTypes, monitorMethods } from "@pingora/db/src/schema";
import {
  monitorPeriodicitySchema,
  monitorRegions,
} from "@pingora/db/src/schema/constants";
import { AVAILABLE_REGIONS } from "@pingora/regions";
...
const httpRequestSchema = z.object({
  ...
  url: z.url().openapi({
    ...
    examples: ["https://openstat.us", "https://www.pingora.dev"],
  }),
  headers: z
    .record(z.string(), z.string())
    .optional()
