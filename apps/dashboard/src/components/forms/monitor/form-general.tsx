...
import { monitorMethods } from "@pingora/db/src/schema";
        ...
        <FormCard>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="sm:col-span-2">
                  ...
                  <FormControl>
                    <Input placeholder="Pingora API" {...field} />
                  </FormControl>
                  <FormMessage />
                  <FormDescription>
                ...
                <FormItem>
                  ...
                  <FormControl>
                    ...
                    >
                      ...
                      >
                        Missing a type?{" "}
                        <a href="mailto:ping@pingora.dev">Contact us</a>
                      </div>
                    </RadioGroup>
                  </FormControl>
                  <FormMessage />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="sm:col-span-2">
                      ...
                      <FormControl>
                        <Input placeholder="pingora.dev" {...field} />
                      </FormControl>
                      <FormMessage />
                      <FormDescription>
          ...
          <FormCardFooter>
            <FormCardFooterInfo>
              Learn more about{" "}
              <Link
                href="https://docs.pingora.dev/tutorial/how-to-create-monitor/"
                rel="noreferrer"
                target="_blank"
              >
                Monitor Type
