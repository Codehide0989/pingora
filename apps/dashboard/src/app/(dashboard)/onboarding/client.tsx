...
const moreActions = [
  ...
  },
  {
    ...
    description: "Book a meeting with us to get you started with Pingora.",
    href: "https://pingora.dev/cal",
  },
  {
    id: "docs",
    title: "Documentation",
    description: "Read our documentation to get started with Pingora.",
    href: "https://docs.pingora.dev",
  },
  {
    id: "changelog",
    title: "Changelog",
    description: "See what's new in Pingora.",
    href: "https://pingora.dev/changelog",
  },
  {
    id: "discord",
    title: "Discord",
    description: "Join our Discord server if you get stuck.",
    href: "https://discord.gg/pingora",
  },
  {
    id: "github",
    title: "GitHub",
    description: "Leave a star on GitHub, request features or report issues.",
    href: "https://github.com/pingora-dev/pingora",
  },
];
    ...
    <SectionGroup>
      <Section>
        <SectionHeader>
          ...
          <SectionDescription>
            Welcome to Pingora. Let&apos;s get you set up.
          </SectionDescription>
        </SectionHeader>
      </Section>
      {step === "1" && (
      ...
      {step === "next" && (
        <>
          <Section>
            <SectionHeader className="h-8 flex-row items-center justify-between">
              <SectionDescription>
                We&apos;d love to know what you are looking for with pingora.
            ...
            <LearnFromForm
              onSubmit={async (values) => {
                await createFeedbackMutation.mutateAsync({
                  message: `I want to use Pingora for *${values.from}${
