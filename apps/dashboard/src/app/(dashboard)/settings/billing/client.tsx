...
import type { Limits } from "@pingora/db/src/schema/plan/schema";
      ...
      <Section>
        ...
        <FormCardGroup>
          <FormCard>
            ...
            <FormCardContent>
              ...
              <div className="flex flex-col gap-2 pt-4">
                ...
                {planAddons["white-label"] ? (
                  <BillingAddons
                    label="White Label"
                    description="Remove the 'powered by pingora.dev' footer from your status pages."
                    addon="white-label"
                    workspace={workspace}
                  />
                ) : null}
            ...
            <FormCardFooter>
              <FormCardFooterInfo>
                Access your <span className="font-medium">billing information</span>{" "}
                and <span className="font-medium">invoices</span>.
              </FormCardFooterInfo>
            </FormCardFooter>
          </FormCard>
          <FormCard>
