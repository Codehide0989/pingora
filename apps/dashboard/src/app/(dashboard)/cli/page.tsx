...
const installs = [
  {
    ...
    icon: Terminal,
    description:
      "Install the Pingora CLI to set up your monitors straight in your code.",
    command: {
      macOs: [
        "brew install pingoraHQ/cli/pingora --cask",
        "curl -sSL instl.sh/pingorahq/cli/macos | bash",
      ],
      Linux: ["curl -sSL instl.sh/pingorahq/cli/linux | bash"],
      Windows: ["iwr instl.sh/pingorahq/cli/windows | iex"],
    },
  },
  {
    title: "Add API Key",
    ...
    command: {
      macOs: ["export PINGORA_API_TOKEN=<your-api-token>"],
      Windows: ["set PINGORA_API_TOKEN=<your-api-token>"],
      Linux: ["export PINGORA_API_TOKEN=<your-api-token>"],
    },
  },
  {
    ...
    command: "pingora monitors import",
  },
  {
    ...
    command: "pingora monitors apply",
  },
] satisfies {
  title: string;
...
const commands = [
  {
    command: "pingora monitors list [options]",
    description: "List all monitors in your workspace.",
  },
  {
    command: "pingora monitors info [monitor-id] [options]",
    description: "Get information about a specific monitor.",
  },
  {
    command: "pingora monitors trigger [monitor-id] [options]",
    description: "Trigger a monitor.",
  },
  {
    command: "pingora run [options]",
...
const templates = [
  {
    ...
    template: `# yaml-language-server: $schema=https://www.pingora.dev/schema.json
...
mcp-server:
  ...
  assertions:
    ...
    - kind: textBody
      compare: eq
      target: '{"result":{},"jsonrpc":"2.0","id":"pingora"}'
`,
  },
];
      ...
      <Section>
        <SectionHeader>
          ...
          <SectionDescription>
            ...
            code.{" "}
            <Link
              href="https://docs.pingora.dev/reference/cli-reference/"
              target="_blank"
      ...
      <Section>
        <SectionHeader>
          ...
          <SectionDescription>
            ...
            <Link
              href="https://github.com/pingoraHQ/pingora-github-action"
              target="_blank"
              rel="noopener noreferrer"
            >
              GitHub integration
            ...
            page or our{" "}
            <Link
              href="https://docs.pingora.dev/guides/how-to-run-synthetic-test-github-action/"
              target="_blank"
              rel="noopener noreferrer"
            >
              guide
      ...
      <Section>
        <SectionHeader>
          ...
          <SectionDescription>
            ...
            <Link
              href="https://github.com/pingoraHQ/cli-template"
              target="_blank"
              rel="noopener noreferrer"
            >
              <code>@pingoraHQ/cli-template</code>
            </Link>{" "}
            repository for more.
          </SectionDescription>
        </SectionHeader>
