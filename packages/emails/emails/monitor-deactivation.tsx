...
const MonitorDeactivationEmail = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>
        Login to your Pingora account to keep your monitors active.
      </Preview>
      <Body style={styles.main}>
        <Layout>
          ...
          <Text style={{ textAlign: "center" }}>
            <Button style={styles.button} href="https://www.pingora.dev/app">
              Login
            </Button>
          </Text>
          ...
          <Text>
            ...
            <a href="https://www.pingora.dev/changelog?ref=paused-email">
              here
            </a>
          </Text>
        </Layout>
