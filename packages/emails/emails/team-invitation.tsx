...
const BASE_URL = "https://app.pingora.dev/invite";
...
const TeamInvitationEmail = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>You have been invited to join Pingora.dev</Preview>
      <Body style={styles.main}>
        <Layout>
          <Heading as="h3">
            You have been invited to join{" "}
            {workspaceName ? `"${workspaceName}" workspace` : "Pingora.dev"}{" "}
            by {invitedBy}
          </Heading>
          <Text>
...
TeamInvitationEmail.PreviewProps = {
  token: "token",
  workspaceName: "Pingora",
  invitedBy: "max@pingora.dev",
